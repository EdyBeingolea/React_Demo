...
const WalfareSolicitudesRechazadas = () => {
  ...
  // Cargar solo las solicitudes rechazados
  useEffect(() => {
    const fetchRequests = async () => {
      try {
        ...
        const response = await axios.get(
          ...
          }/recovery-requests/filtered?status=rechazado`
        );
        ...
        setError(
          "Error al cargar las solicitudes rechazados. Intente nuevamente."
        );
        setRequests([]);
        setFilteredRequests([]);
      } finally {
                  ...
                  <tbody className="divide-y divide-gray-700">
                    {filteredRequests.length > 0 ? (
                      ...
                      <tr>
                        ...
                        >
                          No se encontraron solicitudes rechazados
                        </td>
                      </tr>
                    )}
                  </tbody>
...
export default WalfareSolicitudesRechazadas;
