     ...
     return (
          <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-white to-indigo-50 p-4">
               <motion.div
                    ...
                    className="text-center p-8 md:p-12 bg-white rounded-3xl shadow-2xl max-w-lg w-full border-t-4 border-orange-500 relative overflow-hidden"
               >
                    ...
                    <div className="relative">
                         ...
                         >
                              ...
                              <button
                                   ...
                                   className="group flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-cyan-950 to-cyan-700 text-white rounded-full hover:from-cyan-700 hover:to-cyan-800 transition-all duration-300 shadow-lg hover:shadow-xl w-full md:w-auto mx-auto"
                              >
